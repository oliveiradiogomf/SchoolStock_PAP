            ...
            <div class="nano">
                <div class="nano-content">
                    <ul>
                        ...
                        <li><a href="manutençãopiso1.php"><i class="ti-home"></i>Voltar</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<div style='text-align:left'><h5>Sala L1 Ciências</h5></div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="manL1CN" id="manL1CN" action="manL1CN.php" method="post">
