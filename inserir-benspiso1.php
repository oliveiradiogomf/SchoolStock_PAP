            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- <button class="dropdown-toggle nav-link" data-toggle="dropdown"> -->
                      <!-- <span class="user-avatar">Utilizador</span> -->
                    <!-- </button> -->
                     <!-- <ul class="dropdown-menu dropdown-menu-right"> -->
					  <!-- <li class="dropdown-footer"> -->
                        <!-- <a class="dropdown-link-item" href="alterarpass.php"> <i class="ti-pencil"></i> Alterar Password </a> -->
						<!-- <p> -->
                      <!-- </li> -->
                      <!-- <li class="dropdown-footer"> -->
                        <!-- <a class="dropdown-link-item" href="index.php"> <i class="ti-user"></i> Log Out </a> -->
                      <!-- </li> -->
                    <!-- </ul> -->
                  <!-- </li> -->
              </div>
            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<br>
                                    <h3><b>Inserir Bens (Piso 1)</b></h3>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="inserir-bens" id="inserir-bens" action="inserir-benspiso1.php" method="post">
                                            <div style='text-align:left' class="form-group">	
                                                ...
                                                <?php
                                                 $query = "SELECT * FROM sala where idpiso=16";
                                                ...
                                                <!-- <input name="cor" type="text" class="form-control input-rounded" placeholder="Cor"> -->
