              ...
              <div class="nano-content">
                  <ul>
                    <div class="logo"><a href="admin.php">
						...
						<li><a href="alterarestadopiso0.php"><i class="ti-home"></i>Voltar</a></li>
                  </ul>
              </div>
           </div>
        </div>
            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<br>
                                    <h3><b>Alterar estado dos bens (Piso 0)</b></h3>
                                </div>
								 <div class="card-body">
                                    <div class="basic-form">
                                        <form name="alterarestadopiso0.0" id="idalterar" action="alterarestadopiso0.0.php" method="post">
                                            <div style='text-align:left' class="form-group">		
												...
												<label id="idalterar" for="idalterar"><h6>Escolha a sala que pretente alterar o estado dos bens:</h6></label>
													<div class="mt-2">
														...
														<?php
														 $query = "select * from ((bem INNER JOIN sala on bem.idsala=sala.idsala) INNER JOIN piso on sala.idpiso=piso.idpiso) where piso.idpiso=15";
