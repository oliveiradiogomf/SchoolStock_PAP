            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<div style='text-align:left'><h5>Sala 0.4</h5></div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="abatesealineações0.4" id="abatesealineações0.4" action="abatesealineações0.4.php" method="post">
                                            <div style='text-align:left' class="form-group">
											 ...
											 <?php include "DBConnection.php"; ?>
												 ...
												 <?php
                                                 $query = "SELECT * FROM bem where idsala=0.4";
