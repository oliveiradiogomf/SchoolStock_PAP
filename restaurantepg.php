...
<body>
        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="sala01.php">
                       ...
                       <!--<li><a class="sidebar-sub-toggle"><i class="ti-home"></i> Dashboard <span class="badge badge-primary">2</span> <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        ...
                        <li><a onclick="history.back()"><i class="ti-home"></i>Voltar</a></li>
                        ...
                        <!--<div class="dropdown dib">
                            <div class="header-icon" data-toggle="dropdown">
                                <span class="user-avatar">John
                                    <i class="ti-angle-down f-s-10">0</i>
                                </span>
            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-11">
                            <div class="card">
								...
								<br>
                                    <h3><b>Restaurante Pedagógico</b></h3>
                                </div>
                               <table class="table table-report -mt-2">
                            <thead>
                                <tr>
								    <th class="text-center whitespace-no-wrap">Salas</th>
								    <th class="text-center whitespace-no-wrap">Nome do Bem</th>
									...
									<th class="text-center whitespace-no-wrap">Imagem</th>
