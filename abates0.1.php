...
<body>
    ...
    <div class="content-wrap">
				...
				<center><div class="col-lg-10">
                            <div class="card">
                                <div class="card-title">
								    <br>
                                    <h3><b>Abates dos Bens (Piso 0)</b></h3>
									<br>
                                </div>
								<div style='text-align:left'><h5>Sala 0.1</h5></div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="abates0.1" id="abates0.1" action="abates0.1.php" method="post">
                                            <div style='text-align:left' class="form-group">
											
											     <?php include "DBConnection.php"; ?>
												 
												 <div class= "mt-3"><label><h6>Escolha o bem que pretende abater:</h6></label><div class="mt-2"><select class="form-control input-rounded" name="idbem">
												
												 <?php
                                                 $query = "SELECT * FROM bem where idsala=0.1";
												 ...
												 <p label for="estado"><h6>Estado:</h6></label></p>
									 ...
									 <div class="text-right mt-5">
									   ...
									   <button name="Introduzir	" type="submit" class="btn btn-primary">Abater</button>
		...
		<center> 
        <?php
           if ((isset($_POST["idbem"])) && (isset($_POST["estado"])) )
            {		
				$fidbem = $_POST["idbem"];
				$festado    = $_POST["estado"];
				
            	$query = mysqli_query($link,"update bem set idbem='$fidbem', estado='$festado' where idbem = '$fidbem'");
                if($query){
