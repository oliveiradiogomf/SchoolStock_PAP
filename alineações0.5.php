            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<div style='text-align:left'><h5>Sala 0.5</h5></div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="abatesealineações0.5" id="abatesealineações0.5" action="abatesealineações0.5.php" method="post">
                                            <div style='text-align:left' class="form-group">
											 ...
											 <?php include "DBConnection.php"; ?>
												 ...
												 <?php
                                                 $query = "SELECT * FROM bem where idsala=0.5";
