                ...
                <ul>
                    <div class="logo"><a href="admin.php">
                       ...
                       <!--<li><a class="sidebar-sub-toggle"><i class="ti-home"></i> Dashboard <span class="badge badge-primary">2</span> <span class="sidebar-collapse-icon ti-angle-down"></span></a>
						...
						<li><a href="abatesealineaçõespiso0.php"><i class="ti-home"></i>Voltar</a></li>
            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<br>
                                    <h3><b>Alineações dos Bens (Piso 0)</b></h3>
									<br>
                                </div>
								<div style='text-align:left'><h5>Sala 0.1</h5></div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="alineações0.1" id="alineações0.1" action="alineações0.1.php" method="post">
                                            <div style='text-align:left' class="form-group">
											 ...
											 <?php include "DBConnection.php"; ?>
												 ...
												 <?php
                                                 $query = "SELECT idbem, nomebem FROM bem where idsala=0.1";
                                                 $result = mysqli_query($link,$query);
                                                 while($row = mysqli_fetch_array($result))
                                                 {
                                                 ?>
												  
                                                 <option value = "<?php echo $row['idbem'];?>"> <option value = "<?php echo $row['nomebem'];?>">
												 <?php echo $row['idbem'];?> - <?php echo $row['nomebem'];?></option>
