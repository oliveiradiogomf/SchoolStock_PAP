        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="inserir-obs.php"><i class="ti-eye"></i> Observações </a></li>
                </ul>
            </div>
        </div>
    </div>
						...
						<div class="dropdown dib">
                         <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown">
                           Utilizador
							...
							<a class="dropdown-item" href="index.php"> <i class="ti-back-left"></i> Voltar</a>
                        </div>
