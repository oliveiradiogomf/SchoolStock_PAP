            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<div style='text-align:left'><h5>Pastelaria</h5></div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="abatesealineaçõespast" id="abatesealineaçõespast" action="abatesealineaçõespast.php" method="post">
                                            <div style='text-align:left' class="form-group">
											 ...
											 <?php include "DBConnection.php"; ?>
												 ...
												 <?php
                                                 $query = "SELECT * FROM bem where idsala=11";
