            ...
            <div class="container-fluid">
				...
				<center><div class="col-lg-10">
                            <div class="card">
								...
								<br>
                                    <h3><b>Manutenção dos Bens (Piso 1)</b></h3>
									<br>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="form_inserir-bens" id="form_inserir-bens" action="manutenção.php" method="post">
                                            <div style='text-align:left' class="form-group">
																																			
                                                <label><h6>Em que sala se encontra o bem:</h6></label>
                                                <br>
												<br>
												<center>
											     <a class="btn btn-primary" href="man1.1.php"> Sala 1.1</a>
											     <a class="btn btn-primary" href="man1.2.php"> Sala 1.2</a>
											     <a class="btn btn-primary" href="man1.3.php"> Sala 1.3</a>
											     <a class="btn btn-primary" href="man1.4.php"> Sala 1.4</a>
											     <a class="btn btn-primary" href="man1.5.php"> Sala 1.5</a>
											     <a class="btn btn-primary" href="man1.6.php"> Sala 1.6</a>
											     <a class="btn btn-primary" href="man1.7.php"> Sala 1.7</a>
												 <a class="btn btn-primary" href="manL1.php"> L1</a>
											     <a class="btn btn-primary" href="manL2.php"> L2</a>
											     <a class="btn btn-primary" href="manL3.php"> L3</a>
												 <a class="btn btn-primary" href="manL1CN.php"> L1 CN</a>
												 <a class="btn btn-primary" href="manL2CN.php"> L2 CN</a>
                                                 <br>
												 </center>
                                            </div>
                                      ...
                                      <!--<button>
                                            <div class="button w-24 bg-theme-1 text-blue"><b> Guardar </b></div>
                                      </button>-->
									  <!--<input class="button w-24 bg-theme-1 text-blue" name="Introduzir" type="submit" value="Introduzir" style="width: 100px" /> </center>-->
									  <!--<input class="button w-24 bg-theme-1 text-blue" name="Limpar" type="reset" value="Limpar" style="width: 100px" />-->			  
